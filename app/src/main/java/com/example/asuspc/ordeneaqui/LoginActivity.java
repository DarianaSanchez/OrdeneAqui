...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView forget_text = (TextView)findViewById(R.id.textView_forget);
        forget_text.setPaintFlags(forget_text.getPaintFlags()| Paint.UNDERLINE_TEXT_FLAG);

        TextView register_text = (TextView)findViewById(R.id.textView_register);
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.entrar_button);
